-- Revert company contact information restrictions
-- Allow public access to email and phone fields in companies table

-- Grant SELECT on email and phone columns to anon and authenticated roles
GRANT SELECT (email, phone) ON public.companies TO anon;
GRANT SELECT (email, phone) ON public.companies TO authenticated;

-- Update get_all_companies function to return email and phone for everyone
...
-- Update search_companies function to return email and phone for everyone
