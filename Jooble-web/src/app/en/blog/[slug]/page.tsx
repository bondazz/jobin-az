...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
    ...
    if (!blog) {
        return { title: "Article not found | Jooble.az" };
    }
...
export default async function EnBlogPostPage({ params }: BlogPostPageProps) {
    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            { "@type": "ListItem", "position": 2, "name": "Blog", "item": "https://jooble.az/en/blog" },
            { "@type": "ListItem", "position": 3, "name": blog.title, "item": `https://jooble.az/en/blog/${blog.slug}` }
        ]
    };
