...
const CategoriesClient = () => {
    ...
    const handleJobSelect = async (job: Job) => {
        ...
        if (job.slug) {
            const baseUrl = getLocalizedPath(`/vacancies/${job.slug}`);
    ...
    const DefaultWelcome = () => (
        <div className="h-full flex items-center justify-center p-8">
            <div className="text-center max-w-2xl mx-auto">
                ...
                <h2 className="text-xl font-bold text-foreground mb-4">İş Elanları Kateqoriyaları - Vakansiyalar</h2>
                <div className="text-muted-foreground text-sm leading-relaxed space-y-3 text-left px-4">
                    <p>
                ...
                <div className="lg:hidden fixed inset-0 bg-background z-40 flex flex-col animate-slide-in-right">
                    <MobileHeader
                        ...
                        onClose={async () => {
                            ...
                            const backUrl = categorySlug ? getLocalizedPath(`/categories/${categorySlug}`) : getLocalizedPath('/categories');
