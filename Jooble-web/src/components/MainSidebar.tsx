...
const MainSidebar = () => {
  ...
  const isActivePath = (path: string) => {
    ...
    if (path === "/vacancies") return pathname === "/" || pathname === "/vacancies" || pathname === getLocalizedPath("/") || pathname === localizedPath;
    return pathname?.startsWith(localizedPath) || pathname?.startsWith(path) || false;
  };
        ...
        <div className="grid grid-cols-2 gap-3 mb-3">
          <AnimatedStatsCard variant="primary">
            <div className="flex items-center justify-center gap-1.5 mb-1">
              ...
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">{t('common.daily') || 'Günlük'}</span>
            </div>
          ...
          <AnimatedStatsCard variant="accent">
            <div className="flex items-center justify-center gap-1.5 mb-1">
              ...
              <span className="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">{t('common.monthly') || 'Aylıq'}</span>
            </div>
      ...
      <div className="p-3 border-t border-border/40 bg-gradient-to-r from-job-sidebar/90 to-transparent">
        ...
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center gap-2">
            <LanguageToggle />
            <span className="font-medium text-sm text-foreground">{t('common.theme')}</span>
            <ThemeToggle />
          </div>
        </div>
        ...
        <div className="text-xs text-muted-foreground">
          <div className="flex items-center gap-1 mb-2">
            ...
            <span className="font-medium">
              ...
              . {t('common.footerText')?.replace('© 2024-2026 Jooble.az. ', '') || 'İş elanları və vakansiyalar'}
            </span>
          </div>
