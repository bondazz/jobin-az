...
const JobDetails = ({ jobId, isMobile = false, primaryHeading = true }: JobDetailsProps) => {
  ...
  const handleRevealEmail = async () => {
    ...
    try {
      ...
      const { data, error } = await supabase.rpc("get_job_application_email", {
        job_uuid: job.id,
      });
  ...
  if (!job) {
    return (
      <div className="h-full flex flex-col items-center justify-center bg-gradient-to-br from-job-details to-primary/3">
        <div className="text-center p-8 animate-fade-in h-full overflow-y-auto scrollbar-hide">
          ...
          <div className="flex justify-center">
            <svg
              ...
              aria-hidden="true"
              className="hidden w-full max-w-4xl"
            >
              <defs>
              ...
              <g transform="translate(32 40)">
                <path
                  ...
                  className="card2"
                  filter="url(#shadow)"
                  d="M20.167 0H199.833A20.167 20.167 0 0 1 220 20.167V493.167A20.167 20.167 0 0 1 199.833 513.333H20.167A20.167 20.167 0 0 1 0 493.167V20.167A20.167 20.167 0 0 1 20.167 0z"
                />
                <g transform="translate(24 28)">
                  <path
                    ...
                    rx="12"
                    className="card"
                    d="M11 0H165A11 11 0 0 1 176 11V29.333A11 11 0 0 1 165 40.333H11A11 11 0 0 1 0 29.333V11A11 11 0 0 1 11 0z"
                  />
                  <text
                    x="16"
                    y="30"
                  ...
                  <path
                    ...
                    r="6"
                    className="accent"
                    d="M179.667 20.167A5.5 5.5 0 0 1 174.167 25.667A5.5 5.5 0 0 1 168.667 20.167A5.5 5.5 0 0 1 179.667 20.167z"
                  />
                </g>
                <g transform="translate(24 96)" opacity=".9">
                  <path
                    ...
                    rx="12"
                    className="card"
                    d="M11 0H165A11 11 0 0 1 176 11V25.667A11 11 0 0 1 165 36.667H11A11 11 0 0 1 0 25.667V11A11 11 0 0 1 11 0z"
                  />
                  <path
                    x="0"
                    y="52"
                    ...
                    rx="12"
                    className="card"
                    d="M11 47.667H165A11 11 0 0 1 176 58.667V73.333A11 11 0 0 1 165 84.333H11A11 11 0 0 1 0 73.333V58.667A11 11 0 0 1 11 47.667z"
                  />
                  <path
                    x="0"
                    y="104"
                    ...
                    rx="12"
                    className="card"
                    d="M11 95.333H165A11 11 0 0 1 176 106.333V121A11 11 0 0 1 165 132H11A11 11 0 0 1 0 121V106.333A11 11 0 0 1 11 95.333z"
                  />
                  <path
                    x="0"
                    y="156"
                    ...
                    rx="12"
                    className="card"
                    d="M11 143H165A11 11 0 0 1 176 154V168.667A11 11 0 0 1 165 179.667H11A11 11 0 0 1 0 168.667V154A11 11 0 0 1 11 143z"
                  />
                  <path
                    x="0"
                    y="208"
                    ...
                    rx="12"
                    className="card"
                    d="M11 190.667H165A11 11 0 0 1 176 201.667V216.333A11 11 0 0 1 165 227.333H11A11 11 0 0 1 0 216.333V201.667A11 11 0 0 1 11 190.667z"
                  />
                </g>
              </g>
              ...
              <g transform="translate(288 40)">
                <path
                  ...
                  className="card2"
                  filter="url(#shadow)"
                  d="M20.167 0H419.833A20.167 20.167 0 0 1 440 20.167V493.167A20.167 20.167 0 0 1 419.833 513.333H20.167A20.167 20.167 0 0 1 0 493.167V20.167A20.167 20.167 0 0 1 20.167 0z"
                />
                <path
                  x="20"
                  y="20"
                  ...
                  rx="12"
                  className="card"
                  d="M29.333 18.333H319A11 11 0 0 1 330 29.333V40.333A11 11 0 0 1 319 51.333H29.333A11 11 0 0 1 18.333 40.333V29.333A11 11 0 0 1 29.333 18.333z"
                />
                <path
                  x="372"
                  y="20"
                  ...
                  rx="12"
                  className="brand"
                  d="M352 18.333H410.667A11 11 0 0 1 421.667 29.333V40.333A11 11 0 0 1 410.667 51.333H352A11 11 0 0 1 341 40.333V29.333A11 11 0 0 1 352 18.333z"
                />
                <g transform="translate(20 76)">
                  <path
                    ...
                    rx="16"
                    className="card"
                    d="M14.667 0H388.667A14.667 14.667 0 0 1 403.333 14.667V66A14.667 14.667 0 0 1 388.667 80.667H14.667A14.667 14.667 0 0 1 0 66V14.667A14.667 14.667 0 0 1 14.667 0z"
                  />
                  <path
                    x="0"
                    y="108"
                    ...
                    rx="16"
                    className="card"
                    d="M14.667 99H388.667A14.667 14.667 0 0 1 403.333 113.667V165A14.667 14.667 0 0 1 388.667 179.667H14.667A14.667 14.667 0 0 1 0 165V113.667A14.667 14.667 0 0 1 14.667 99z"
                  />
                  <path
                    id="chosen"
                    x="0"
                    ...
                    d="M14.667 198H388.667A14.667 14.667 0 0 1 403.333 212.667V264A14.667 14.667 0 0 1 388.667 278.667H14.667A14.667 14.667 0 0 1 0 264V212.667A14.667 14.667 0 0 1 14.667 198z"
                  />
                  <path
                    x="0"
                    y="324"
                    ...
                    rx="16"
                    className="card"
                    d="M14.667 297H388.667A14.667 14.667 0 0 1 403.333 311.667V363A14.667 14.667 0 0 1 388.667 377.667H14.667A14.667 14.667 0 0 1 0 363V311.667A14.667 14.667 0 0 1 14.667 297z"
                  />
                  <path
                    x="0"
                    y="432"
                    ...
                    rx="16"
                    className="card"
                    d="M14.667 396H388.667A14.667 14.667 0 0 1 403.333 410.667V462A14.667 14.667 0 0 1 388.667 476.667H14.667A14.667 14.667 0 0 1 0 462V410.667A14.667 14.667 0 0 1 14.667 396z"
                  />
                  <g opacity=".22">
                    <path
                      x="18"
                      ...
                      rx="6"
                      className="ink"
                      d="M22 16.5H258.5A5.5 5.5 0 0 1 264 22V22A5.5 5.5 0 0 1 258.5 27.5H22A5.5 5.5 0 0 1 16.5 22V22A5.5 5.5 0 0 1 22 16.5z"
                    />
                    <path
                      x="18"
                      y="40"
                      ...
                      rx="5"
                      className="weak"
                      d="M21.083 36.667H204.417A4.583 4.583 0 0 1 209 41.25V41.25A4.583 4.583 0 0 1 204.417 45.833H21.083A4.583 4.583 0 0 1 16.5 41.25V41.25A4.583 4.583 0 0 1 21.083 36.667z"
                    />
                    <path
                      x="18"
                      y="126"
                      ...
                      rx="6"
                      className="ink"
                      d="M22 115.5H240.167A5.5 5.5 0 0 1 245.667 121V121A5.5 5.5 0 0 1 240.167 126.5H22A5.5 5.5 0 0 1 16.5 121V121A5.5 5.5 0 0 1 22 115.5z"
                    />
                    <path
                      x="18"
                      y="148"
                      ...
                      rx="5"
                      className="weak"
                      d="M21.083 135.667H186.083A4.583 4.583 0 0 1 190.667 140.25V140.25A4.583 4.583 0 0 1 186.083 144.833H21.083A4.583 4.583 0 0 1 16.5 140.25V140.25A4.583 4.583 0 0 1 21.083 135.667z"
                    />
                    <path
                      x="18"
                      y="234"
                      ...
                      rx="6"
                      className="ink"
                      d="M22 214.5H267.667A5.5 5.5 0 0 1 273.167 220V220A5.5 5.5 0 0 1 267.667 225.5H22A5.5 5.5 0 0 1 16.5 220V220A5.5 5.5 0 0 1 22 214.5z"
                    />
                    <path
                      x="18"
                      y="256"
                      ...
                      rx="5"
                      className="weak"
                      d="M21.083 234.667H195.25A4.583 4.583 0 0 1 199.833 239.25V239.25A4.583 4.583 0 0 1 195.25 243.833H21.083A4.583 4.583 0 0 1 16.5 239.25V239.25A4.583 4.583 0 0 1 21.083 234.667z"
                    />
                  </g>
                </g>
              </g>
              ...
              <g id="panelWrap" transform="translate(808 40)" filter="url(#shadow)">
                <path
                  ...
                  rx="22"
                  className="card2"
                  d="M760.833 36.667H1050.5A20.167 20.167 0 0 1 1070.667 56.833V529.833A20.167 20.167 0 0 1 1050.5 550H760.833A20.167 20.167 0 0 1 740.667 529.833V56.833A20.167 20.167 0 0 1 760.833 36.667z"
                />
                <path
                  x="808"
                  y="52"
                  ...
                  rx="5"
                  fill="url(#shimmer)"
                  d="M745.25 47.667H1011.083A4.583 4.583 0 0 1 1015.667 52.25V52.25A4.583 4.583 0 0 1 1011.083 56.833H745.25A4.583 4.583 0 0 1 740.667 52.25V52.25A4.583 4.583 0 0 1 745.25 47.667z"
                />
                <path
                  x="808"
                  y="72"
                  ...
                  rx="5"
                  fill="url(#shimmer)"
                  d="M745.25 66H928.583A4.583 4.583 0 0 1 933.167 70.583V70.583A4.583 4.583 0 0 1 928.583 75.167H745.25A4.583 4.583 0 0 1 740.667 70.583V70.583A4.583 4.583 0 0 1 745.25 66z"
                />
                <path
                  x="808"
                  y="110"
                  ...
                  rx="5"
                  fill="url(#shimmer)"
                  d="M745.25 100.833H1025.75A4.583 4.583 0 0 1 1030.333 105.417V105.417A4.583 4.583 0 0 1 1025.75 110H745.25A4.583 4.583 0 0 1 740.667 105.417V105.417A4.583 4.583 0 0 1 745.25 100.833z"
                />
                <path
                  x="808"
                  y="130"
                  ...
                  rx="5"
                  fill="url(#shimmer)"
                  d="M745.25 119.167H996.417A4.583 4.583 0 0 1 1001 123.75V123.75A4.583 4.583 0 0 1 996.417 128.333H745.25A4.583 4.583 0 0 1 740.667 123.75V123.75A4.583 4.583 0 0 1 745.25 119.167z"
                />
                <path
                  x="808"
                  y="150"
                  ...
                  rx="5"
                  fill="url(#shimmer)"
                  d="M745.25 137.5H974.417A4.583 4.583 0 0 1 979 142.083V142.083A4.583 4.583 0 0 1 974.417 146.667H745.25A4.583 4.583 0 0 1 740.667 142.083V142.083A4.583 4.583 0 0 1 745.25 137.5z"
                />
                <path
                  x="808"
                  y="170"
                  ...
                  rx="5"
                  fill="url(#shimmer)"
                  d="M745.25 155.833H1029.417A4.583 4.583 0 0 1 1034 160.417V160.417A4.583 4.583 0 0 1 1029.417 165H745.25A4.583 4.583 0 0 1 740.667 160.417V160.417A4.583 4.583 0 0 1 745.25 155.833z"
                />
                <path
                  x="808"
                  y="190"
                  ...
                  rx="5"
                  fill="url(#shimmer)"
                  d="M745.25 174.167H983.583A4.583 4.583 0 0 1 988.167 178.75V178.75A4.583 4.583 0 0 1 983.583 183.333H745.25A4.583 4.583 0 0 1 740.667 178.75V178.75A4.583 4.583 0 0 1 745.25 174.167z"
                />
                <g id="cta">
                  <path
                    x="900"
                ...
                <g transform="translate(836.167 478.5)">
                  <path
                    ...
                    fill="none"
                    stroke="#fff"
                    strokeWidth="3.6666666666666665"
                    strokeLinecap="round"
              ...
              <g id="cursor">
                <path
                  points="0,0 26,12 12,16 16,30"
                  fill="#fff"
                  stroke="rgba(0,0,0,.28)"
                  strokeWidth="1.0999999999999999"
                  d="M0 0L23.833 11L11 14.667L14.667 27.5Z"
                />
              </g>
      ...
      >
        ...
        >
          <div className="flex items-start gap-6">
            ...
            <div
              className={`${isMobile ? "w-16 h-16" : "w-20 h-20"} rounded-2xl bg-gradient-to-br from-primary/5 to-primary/15 border border-primary/10 flex items-center justify-center flex-shrink-0 shadow-sm`}
            >
              {job.companies?.logo ? (
                <img
            ...
            <div className="flex-1 min-w-0 space-y-3">
              ...
              <div className="flex items-center gap-3">
                {job.companies?.slug ? (
                  <Link href={getLocalizedPath(`/companies/${job.companies.slug}`)}>
                    <h2
              ...
              <div className="flex flex-wrap items-center gap-3">
                {job.categories?.slug ? (
                  <Link href={getLocalizedPath(`/categories/${job.categories.slug}`)}>
                    <Badge
                      variant="secondary"
                ...
                {job.salary && job.salary !== "Müzakirə" && (
                  <Badge
                    variant="outline"
                    className={`${isMobile ? "text-xs" : "text-sm"} font-medium border-muted-foreground/30 text-muted-foreground`}
                  >
                    {job.salary}
                  </Badge>
                )}
        ...
        <div className={`${isMobile ? "p-4" : "p-6"} space-y-4`}>
          ...
          <div className={`${isMobile ? "space-y-3" : "flex items-start gap-4"}`}>
            ...
            <div
              className={`${isMobile ? "w-full" : "flex-1"} grid ${isMobile ? "grid-cols-2 gap-2" : "grid-cols-3 gap-3"}`}
            >
              ...
              <div className={`flex items-center gap-2 ${isMobile ? "p-2" : "p-2"} rounded-md bg-muted/20`}>
                ...
                <div className="min-w-0 flex-1">
                  <p className="text-xs font-medium text-foreground truncate">{job.salary || (t('common.discussion') || "Müzakirə")}</p>
                </div>
              </div>
            ...
            <div className={`${isMobile ? "flex flex-row gap-2" : "flex flex-row gap-2 min-w-[250px]"}`}>
              {job.expiration_date && (
                <Button
                  variant="outline"
                  size="sm"
                  className={`${isMobile ? "flex-1" : "flex-1"} ${expired ? "border-red-300/70 text-red-600 bg-red-50" : "border-orange-300/70 text-orange-600 hover:bg-orange-100 hover:text-orange-700"} text-xs`}
                >
              ...
              <Button
                variant="outline"
                size="sm"
                className={`${isMobile ? "flex-1" : "flex-1"} border-primary/30 hover:bg-primary hover:text-white ${isSaved ? "bg-primary text-white" : "text-primary"} text-xs`}
                onClick={handleSaveJob}
              >
                <Bookmark className={`w-3 h-3 ${isMobile ? "mr-1" : "mr-1"} ${isSaved ? "fill-current" : ""}`} />
                {isSaved ? (t('common.saved') || "Saxlanıldı") : (t('common.save') || "Saxla")}
              </Button>
              <Button
                variant="outline"
                size="sm"
          ...
          <div className="space-y-3">
            {(() => {
              ...
              return (
                <HeadingTag
                  className={`${isMobile ? "text-lg" : "text-xl"} font-bold text-foreground text-center relative`}
                >
          ...
          {(job.companies?.email || job.companies?.phone || job.companies?.website) && (
            <div className="space-y-3">
              <h2 className={`${isMobile ? "text-lg" : "text-xl"} font-bold text-foreground`}>
                {job.companies?.name || "Şirkət"} - {t('companies.contactInfo') || 'Əlaqə Məlumatları'}
              </h2>
              <div className={`grid ${isMobile ? "grid-cols-1" : "grid-cols-1 sm:grid-cols-2"} gap-3`}>
                {job.companies?.email && (
                  <div className={`flex items-center gap-2 ${isMobile ? "p-2" : "p-3"} rounded-lg bg-muted/30`}>
                    ...
                    <div className="min-w-0 flex-1">
                      <p className={`${isMobile ? "text-xs" : "text-sm"} font-medium text-foreground`}>{t('common.email') || 'E-mail'}</p>
                      <a
                ...
                {job.companies?.website && (
                  <div className={`flex items-center gap-2 ${isMobile ? "p-2" : "p-3"} rounded-lg bg-muted/30`}>
                    ...
                    <div className="min-w-0 flex-1">
                      <p className={`${isMobile ? "text-xs" : "text-sm"} font-medium text-foreground`}>{t('common.website') || 'Veb Sayt'}</p>
                      <a
