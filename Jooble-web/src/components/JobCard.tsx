  ...
  return <div onClick={onClick} className={`
    ...
    <div className="flex items-center gap-1.5 sm:gap-2 flex-1 min-w-0 relative z-10">
      ...
      <div className="flex-1 min-w-0 overflow-hidden">
        ...
        {job.slug ? (
          <Link href={getLocalizedPath(`/vacancies/${job.slug}`)} onClick={(e) => e.stopPropagation()}>
        ...
        <div className="flex items-center gap-1 sm:gap-2 mt-0.5">
          <div className="flex items-center gap-0.5 sm:gap-1 min-w-0">
            ...
            {job.companySlug ? (
              <Link href={getLocalizedPath(`/companies/${job.companySlug}`)} onClick={(e) => e.stopPropagation()}>
