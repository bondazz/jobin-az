    ...
    const DefaultWelcome = () => (
        <div className="h-full flex items-center justify-center p-8">
            <div className="text-center max-w-2xl mx-auto">
                ...
                <h2 className="text-xl font-bold text-foreground mb-4">Regionlar üzrə İş Elanları - Vakansiyalar</h2>
                <div className="text-muted-foreground text-sm leading-relaxed space-y-3 text-left px-4">
                    <p>
            ...
            {selectedJob && (
                <div className="lg:hidden fixed inset-0 bg-background z-40 flex flex-col animate-slide-in-right">
                    <MobileHeader
                        ...
                        onClose={async () => {
                            setSelectedJob(null);
                            const backUrl = regionSlug ? getLocalizedPath(`/regions/${regionSlug}`) : getLocalizedPath('/regions');
