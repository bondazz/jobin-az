          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-1">
              <div className="relative w-32">
                ...
                <Input placeholder="Axtarış..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-7 pr-2 py-1 h-8 bg-background/80 backdrop-blur-sm border-border/50 rounded-lg text-xs" />
              </div>
              <div className="relative w-24">
                <MapPin className="absolute left-2 top-1/2 transform -translate-y-1/2 w-3 h-3 text-muted-foreground" />
                <Input placeholder="Yer..." value={locationFilter} onChange={e => setLocationFilter(e.target.value)} className="pl-7 pr-2 py-1 h-8 bg-background/80 backdrop-blur-sm border-border/50 rounded-lg text-xs" />
              </div>
            </div>
          </div>
        </div>
