...
const JobListings = ({
  ...
  return <div className="flex-1 flex flex-col h-full bg-background">
      ...
      <div className="flex-1 overflow-y-auto p-2 bg-gradient-to-b from-transparent to-primary/5 w-full max-w-[100%] lg:max-w-[calc(100%+80px)] mx-auto lg:min-h-[calc(100vh-200px)] lg:px-0 py-0">
        <div className="flex flex-col gap-2 justify-center items-center w-full max-w-full px-2 py-[12px]">
