          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 relative z-10">
                <div
                  className={`w-6 h-6 rounded-md flex items-center justify-center transition-all duration-300 ${isActive
              ...
              {item.count !== null && item.count > 0 && (
                <Badge
                  ...
                  className={`ml-auto text-xs px-1.5 py-0.5 relative z-10 ${isActive ? "bg-white/25 text-white border-white/40" : "bg-gradient-to-r from-primary/15 to-accent/10 text-primary border-primary/25"
                    }`}
                >
                  {item.count}
                </Badge>
      ...
      <div className="p-3 border-t border-border/40 bg-gradient-to-r from-job-sidebar/90 to-transparent">
        ...
        <div className="text-xs text-muted-foreground">
          ...
          <div className="flex flex-wrap gap-2">
            <a
              href="https://jobin.az/sitemap.xml"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://jobin.az/sitemap_blog.xml"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-1.5 px-2 py-1 rounded-md bg-primary/10 text-primary text-[10px] font-medium hover:bg-primary/20 transition-all duration-200 border border-primary/20"
            >
