...
import { Briefcase, Tag, Building, Bookmark, Bell, TrendingUp, Info, DollarSign, Calendar, BarChart3, FileText, Share2, Rss, Facebook, Instagram, Linkedin, MessageCircle, Send } from 'lucide-react';
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                <div className={`w-6 h-6 rounded-md flex items-center justify-center transition-colors ${isActive ? 'bg-white/20 text-white' : 'bg-primary/10 text-primary group-hover:bg-primary/20'
                  }`}>
              ...
              {item.count !== null && item.count > 0 && (
                <Badge
                  ...
                  className={`ml-auto text-xs px-1.5 py-0.5 ${isActive
