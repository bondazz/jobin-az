        ...
        <div className="space-y-6">
          ...
          <div className="w-full max-w-md mx-auto mb-6">
            <svg xmlns="http://www.w3.org/2000/svg"
                 ...
                 viewBox="0 0 360 160"
                 role="img" aria-label="Phone top with 5 sequential push notifications">
              <defs>
              ...
              <g clipPath="url(#phoneTopClip)">
                ...
                <g id="n1" filter="url(#softShadow)" transform="translate(20,-120)" opacity="0">
                  <animateTransform attributeName="transform" type="translate" begin="0s" dur="0.6s"
                                    from="20,-120" to="20,48" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                  <animate attributeName="opacity" begin="0s" dur="0.28s" from="0" to="1" fill="freeze"/>
                  <animateTransform attributeName="transform" type="translate" begin="4.1s" dur="0.5s"
                                    from="20,48" to="20,-120" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                ...
                <g id="n2" filter="url(#softShadow)" transform="translate(20,-120)" opacity="0">
                  <animateTransform attributeName="transform" type="translate" begin="4.1s" dur="0.6s"
                                    from="20,-120" to="20,48" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                  <animate attributeName="opacity" begin="4.1s" dur="0.28s" from="0" to="1" fill="freeze"/>
                  <animateTransform attributeName="transform" type="translate" begin="8.2s" dur="0.5s"
                                    from="20,48" to="20,-120" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                ...
                <g id="n3" filter="url(#softShadow)" transform="translate(20,-120)" opacity="0">
                  <animateTransform attributeName="transform" type="translate" begin="8.2s" dur="0.6s"
                                    from="20,-120" to="20,48" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                  <animate attributeName="opacity" begin="8.2s" dur="0.28s" from="0" to="1" fill="freeze"/>
                  <animateTransform attributeName="transform" type="translate" begin="12.3s" dur="0.5s"
                                    from="20,48" to="20,-120" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                ...
                <g id="n4" filter="url(#softShadow)" transform="translate(20,-120)" opacity="0">
                  <animateTransform attributeName="transform" type="translate" begin="12.3s" dur="0.6s"
                                    from="20,-120" to="20,48" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                  <animate attributeName="opacity" begin="12.3s" dur="0.28s" from="0" to="1" fill="freeze"/>
                  <animateTransform attributeName="transform" type="translate" begin="16.4s" dur="0.5s"
                                    from="20,48" to="20,-120" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                ...
                <g id="n5" filter="url(#softShadow)" transform="translate(20,-120)" opacity="0">
                  <animateTransform attributeName="transform" type="translate" begin="16.4s" dur="0.6s"
                                    from="20,-120" to="20,48" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
                  <animate attributeName="opacity" begin="16.4s" dur="0.28s" from="0" to="1" fill="freeze"/>
                  <animateTransform attributeName="transform" type="translate" begin="20.5s" dur="0.5s"
                                    from="20,48" to="20,-120" fill="freeze" calcMode="spline" keySplines="0.2 0.8 0.2 1"/>
