...
const Bildirisler = () => {
  ...
  // Static SEO for bildirisler page
  useSEO({
  ...
  const handleJobSelect = (job: Job) => {
    if (job.slug) {
      window.location.href = `/bildirisler/${job.slug}`;
    }
  };
  ...
  return (
    <>
      {/* Structured Data for Bildirisler Page */}
      <script type="application/ld+json">
        {JSON.stringify({
          "@context": "https://schema.org",
          "@type": "CollectionPage",
          "name": "Bildirişlər",
          "description": "Azərbaycanda ən son iş bildirişləri və vakansiyalar",
          "url": "https://jooble.az/bildirisler",
          "mainEntity": {
            "@type": "ItemList",
            "name": "İş Bildirişləri"
          }
        })}
      </script>
